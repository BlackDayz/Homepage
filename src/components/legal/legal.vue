<template>
    <div class="legalinformation black font relative">
        <div id="Datenschutz" class="bg_white left">
            ...
            <p>Eine Liste der Aufsichtsbehörden (für den nichtöffentlichen Bereich) mit Anschrift finden Sie
                ...
                <a href="https://www.bfdi.bund.de/DE/Infothek/Anschriften_Links/anschriften_links-node.html"
                    ...
                    class="black">https://www.bfdi.bund.de/DE/Infothek/Anschriften_Links/anschriften_links-node.html</a>.
            </p>
            <p></p>
            ...
            <p>Wir verwenden Ihre Daten nicht, um Rückschlüsse auf Ihre Person zu ziehen. Informationen dieser
                Art
                werden von uns ggfs. statistisch ausgewertet, um unseren Internetauftritt und die
                dahinterstehende
            ...
            <h3>Art und Zweck der Verarbeitung:</h3>
            <p>Wir setzen Adobe Typekit zur visuellen Gestaltung unserer Website ein. Typekit ist ein Dienst der
                Adobe Systems Software Ireland Companies (4-6 Riverwalk, Citywest Business Campus, Dublin 24,
                Republic of Ireland; nachfolgend „Adobe“), der uns den Zugriff auf eine Schriftartenbibliothek
                gewährt. Zur Einbindung der von uns benutzten Schriftarten, muss Ihr Browser eine Verbindung zu
                einem Server von Adobe in den USA aufbauen und die für unsere Website benötigte Schriftart
                herunterladen. Adobe erhält hierdurch die Information, dass von Ihrer IP-Adresse unsere Website
                aufgerufen wurde. Weitere Informationen zu Adobe Typekit finden Sie in den Datenschutzhinweisen
                von
                Adobe, die Sie hier abrufen können: <a href="https://www.adobe.com/de/privacy/policy.html"
                    target="_blank">https://www.adobe.com/de/privacy/policy.html</a></p>
            <h3>Rechtsgrundlage:</h3>
            <p>Rechtsgrundlage für die Einbindung von Adobe Typekit und dem damit verbundenen Datentransfer zu
                Adobe
                ist Ihre Einwilligung (Art. 6 Abs. 1 lit. a DSGVO).</p>
            <h3>Empfänger:</h3>
            <p>Der Aufruf von Scriptbibliotheken oder Schriftbibliotheken löst automatisch eine Verbindung zum
                Betreiber der Bibliothek aus. Informationen über die Nutzung Ihrer Daten durch Adobe Typekit Web
                Fonts Sie unter <a href="https://typekit.com/" target="_blank"
                    class="black">https://typekit.com/</a> und in der Datenschutzerklärung von Adobe Typekit: <a
                    href="https://www.adobe.com/de/privacy/policies/typekit.html" target="_blank"
                    class="black">https://www.adobe.com/de/privacy/policies/typekit.html</a>.</p>
            <h3>Speicherdauer:</h3>
            <p>Wir erheben keine personenbezogenen Daten durch die Einbindung von Adobe Typekit Web Fonts.</p>
            <h3>Drittlandtransfer:</h3>
            <p>Adobe ist unter dem Privacy-Shield-Abkommen zertifiziert und bietet hierdurch eine Garantie, das
                europäische Datenschutzrecht einzuhalten (<a
                    href="https://www.privacyshield.gov/participant?id=a2zt0000000TNo9AAG&status=Active"
                    target="_blank"
                    class="black">https://www.privacyshield.gov/participant?id=a2zt0000000TNo9AAG&status=Active</a>).
            </p>
            <h3>Bereitstellung vorgeschrieben oder erforderlich:</h3>
            ...
            <h3>Art und Zweck der Verarbeitung:</h3>
            <p>Auf einigen unserer Webseiten betten wir YouTube-Videos ein. Betreiber der entsprechenden Plugins
                ist
                die YouTube, LLC, 901 Cherry Ave., San Bruno, CA 94066, USA (nachfolgend „YouTube“). Wenn Sie
                eine
                Seite mit dem YouTube-Plugin besuchen, wird eine Verbindung zu Servern von YouTube hergestellt.
                Dabei wird YouTube mitgeteilt, welche Seiten Sie besuchen. Wenn Sie in Ihrem YouTube-Account
            ...
            <p>Weitere Informationen zu Zweck und Umfang der Datenerhebung und ihrer Verarbeitung durch YouTube
                ...
                Privatsphäre (<a href="https://policies.google.com/privacy" target="_blank"
                    class="black">https://policies.google.com/privacy</a>). Google verarbeitet Ihre Daten in den
                USA
                und hat sich dem EU-US Privacy Shield unterworfen https://www.privacyshield.gov/EU-US-Framework
            </p>
            <h3>Rechtsgrundlage:</h3>
            <p>Rechtsgrundlage für die Einbindung von YouTube und dem damit verbundenen Datentransfer zu Google
                ist
            ...
            <p>Wer das Speichern von Cookies für das Google-Ad-Programm deaktiviert hat, wird auch beim
                Anschauen
                ...
                Sie
                das Speichern von Cookies im Browser blockieren.</p>
            <p>Weitere Informationen zum Datenschutz bei „YouTube“ finden Sie in der Datenschutzerklärung des
                Anbieters unter: <a href="https://www.google.de/intl/de/policies/privacy/" target="_blank"
                    class="black">https://www.google.de/intl/de/policies/privacy/ </a></p>
            <h3>Drittlandtransfer:</h3>
            <p>Google verarbeitet Ihre Daten in den USA und hat sich dem EU_US Privacy Shield unterworfen <a
                    ...
                    class="black">https://www.privacyshield.gov/EU-US-Framework</a>.</p>
            <h3>Bereitstellung vorgeschrieben oder erforderlich:</h3>
            <p>Die Bereitstellung Ihrer personenbezogenen Daten erfolgt freiwillig, allein auf Basis Ihrer
                Einwilligung. Sofern Sie den Zugriff unterbinden, kann es hierdurch zu Funktionseinschränkungen
                auf
                der Website kommen.</p>
            <p></p>
            ...
            <p><em>Die Datenschutzerklärung wurde mithilfe der activeMind AG erstellt, den Experten für <a
                        ...
                        rel="noopener" class="black">externe Datenschutzbeauftragte</a> (Version
                    #2019-04-10).</em>
            </p>
        ...
        <div id="Impressum" class="bg_white right">
            <div class='impressum'>
                ...
                <p><strong>Kontakt:</strong> <br>
                    Telefon: <a href="#" style="user-select:all" class="black">Auf Anfrage</a><br>
                    E-Mail: <a href='mailto:info@blackdayz.de' class="black">info@blackdayz.de</a></br></p>
                <p><strong>Haftungsausschluss: </strong><br><br><strong>Haftung für Inhalte</strong><br><br>
                    ...
                    Rechtsverletzungen
                    werden wir derartige Links umgehend entfernen.<br><br><strong>Urheberrecht</strong><br><br>
                ...
                Website Impressum von <a href="https://www.impressum-generator.de" target="_blank"
                    class="black">impressum-generator.de</a>
            </div>
        </div>
    </div>
