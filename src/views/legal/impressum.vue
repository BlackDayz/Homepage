...
<template>
    <div class="impressum my-4 mx-auto w-100 mx-5 px-5">
        ...
        <p>
            ...
            E-Mail: <a href="mailto:info@blackdayz.de" class="black">info@blackdayz.de</a><br />
        </p>
        <p>
            ...
            wir diese Inhalte umgehend entfernen.<br /><br /><strong>Haftung für Links</strong
            ><br /><br />
        ...
        <a href="https://www.impressum-generator.de" target="_blank" class="black"
